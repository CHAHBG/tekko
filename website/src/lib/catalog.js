export const themeCatalog = {
  ...
  ocean: {
    label: 'Bleu Océan',
    description: 'Frais et confiant — bleu profond et accents lumineux.',
    accent: '#2e7cf6',
    surface: 'linear-gradient(155deg, rgba(8,20,40,0.98) 0%, rgba(16,46,86,0.96) 100%)',
    highlight: '#9ec8ff',
    text: '#eef5ff',
    panel: 'rgba(12,30,60,0.42)',
  },
  forest: {
    label: 'Vert Forêt',
    description: 'Naturel et rassurant — vert riche et touches claires.',
    accent: '#1f9d6b',
    surface: 'linear-gradient(155deg, rgba(10,32,24,0.98) 0%, rgba(18,64,46,0.96) 100%)',
    highlight: '#9fe9c6',
    text: '#eefff6',
    panel: 'rgba(12,40,30,0.40)',
  },
  rose: {
    label: 'Rose Poudré',
    description: 'Doux et élégant — rose chaleureux sur fond clair.',
    accent: '#e0568b',
    surface: 'linear-gradient(160deg, rgba(252,242,247,0.98) 0%, rgba(244,224,234,0.95) 100%)',
    highlight: '#ffd0e2',
    text: '#2a1822',
  ...
  sunset: {
    ...
    description: 'Chaud et vibrant — dégradé orangé énergique.',
    accent: '#f2683c',
    surface: 'linear-gradient(150deg, rgba(40,16,12,0.98) 0%, rgba(96,40,24,0.96) 100%)',
    highlight: '#ffb88a',
    text: '#fff3ec',
    panel: 'rgba(60,28,18,0.40)',
  },
  royal: {
    label: 'Violet Royal',
    description: 'Premium et créatif — violet profond et reflets clairs.',
    accent: '#7c5cff',
    surface: 'linear-gradient(155deg, rgba(20,14,40,0.98) 0%, rgba(42,28,82,0.96) 100%)',
    highlight: '#c3b2ff',
    text: '#f2eeff',
    panel: 'rgba(28,18,56,0.42)',
  },
  sahel: {
    label: 'Sahel',
    description: 'Sable et or — chaleur ouest-africaine, lumineux.',
    accent: '#c89b3c',
    surface: 'linear-gradient(160deg, rgba(250,244,232,0.98) 0%, rgba(236,222,196,0.95) 100%)',
    highlight: '#efd9a0',
    text: '#2c2310',
  ...
  mono: {
    label: 'Noir & Blanc',
    description: 'Minimal et intemporel — contraste net, sans couleur.',
    accent: '#2b2b2b',
    surface: 'linear-gradient(160deg, rgba(248,248,248,0.98) 0%, rgba(228,228,228,0.95) 100%)',
    highlight: '#9a9a9a',
    text: '#141414',
    panel: 'rgba(255,255,255,0.6)',
  },
...
export const cardTemplates = [
  ...
  },
  {
    ...
    emoji: '🏢',
    profile: { fullName: 'Modou Faye', role: 'Agent Immobilier', company: 'Dakar Immo', email: 'modou@dakarimmo.sn', phone: '+221 77 555 12 34' },
    customization: { theme: 'sahel', accent: '#c89b3c', material: 'Pearl white', finish: 'Satin', foil: 'Gold foil', cardLayout: 'split', fontStyle: 'moderne' },
  },
  {
    key: 'restaurant',
    label: 'Restaurateur',
    emoji: '🍽️',
    profile: { fullName: 'Khady Sarr', role: 'Cheffe & Restauratrice', company: 'Le Téranga', email: 'contact@leteranga.sn', phone: '+221 33 820 00 00' },
    customization: { theme: 'teranga', accent: '#8e6f48', material: 'Pearl white', finish: 'Satin', foil: 'Copper foil', cardLayout: 'banner', fontStyle: 'arrondi' },
  },
  {
    key: 'beauty',
    ...
    emoji: '💇🏾',
    profile: { fullName: 'Aïssatou Ndoye', role: 'Esthéticienne & Coiffeuse', company: 'Studio Sañse', email: 'aissatou@sanse.sn', phone: '+221 78 333 22 11' },
    customization: { theme: 'rose', accent: '#e0568b', material: 'Soft touch PVC', finish: 'Gloss', foil: 'No foil', cardLayout: 'gradient', fontStyle: 'arrondi' },
  },
  {
    key: 'coach',
    label: 'Coach & Consultant',
    emoji: '🎯',
    profile: { fullName: 'Cheikh Sy', role: 'Coach en développement', company: '', email: 'cheikh@sycoaching.com', website: 'sycoaching.com' },
    customization: { theme: 'pulse', accent: '#2bd1ff', material: 'Frosted black', finish: 'Gloss', foil: 'Silver foil', cardLayout: 'bold', fontStyle: 'technique' },
  },
  {
    key: 'photographer',
    label: 'Photographe',
    emoji: '📷',
    profile: { fullName: 'Pape Diop', role: 'Photographe & Vidéaste', company: 'Pixel Dakar', email: 'pape@pixeldakar.sn', website: 'pixeldakar.sn' },
    customization: { theme: 'mono', accent: '#2b2b2b', material: 'Soft touch PVC', finish: 'Matte', foil: 'No foil', cardLayout: 'banner', fontStyle: 'moderne' },
  },
  {
    key: 'ngo',
    label: 'ONG / Association',
    emoji: '🤝',
    profile: { fullName: 'Mariama Bâ', role: 'Coordinatrice de programme', company: 'ONG Jàppoo', email: 'mariama@jappoo.org', phone: '+221 33 869 11 11' },
    customization: { theme: 'forest', accent: '#1f9d6b', material: 'Pearl white', finish: 'Matte', foil: 'No foil', cardLayout: 'classic', fontStyle: 'moderne' },
  },
  {
    key: 'influencer',
    label: 'Créateur de contenu',
    emoji: '✨',
    profile: { fullName: 'Binta Gueye', role: 'Créatrice de contenu', company: '', email: 'binta@bintacreates.com', bio: 'Lifestyle · Mode · Dakar' },
    customization: { theme: 'sunset', accent: '#f2683c', material: 'Soft touch PVC', finish: 'Gloss', foil: 'No foil', cardLayout: 'grid', fontStyle: 'arrondi' },
  },
  {
    key: 'tailor',
    label: 'Couturier / Styliste',
    emoji: '🧵',
    profile: { fullName: 'Ousseynou Mbaye', role: 'Styliste-Modéliste', company: 'Atelier Mbaye', email: 'atelier@mbaye.sn', phone: '+221 77 444 55 66' },
    customization: { theme: 'royal', accent: '#7c5cff', material: 'Pearl white', finish: 'Satin', foil: 'Gold foil', cardLayout: 'elegant', fontStyle: 'elegant' },
  },
];